        ...
        <div className="p-6">
            ...
            {produk.aktif ? (
                <button
                    ...
                    className={`w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-blue-700 transition ${loading || sudahBeli[produk.id] ? "opacity-50 cursor-not-allowed" : ""
                        }`}
            ...
            {isOwner && (
                <button
                    ...
                    className="w-full mt-2 bg-gray-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-gray-700 transition"
